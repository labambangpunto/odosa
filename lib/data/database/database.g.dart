...
class Debt extends DataClass implements Insertable<Debt> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, personName, amount, type, isSettled, dueDate);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Debt &&
    ...
    : super(
        TableManagerState(
          ...
          createCompanionCallback: ({
            ...
            required String name,
            Value<double> balance = const Value.absent(),
          }) => AccountsCompanion.insert(id: id, name: name, balance: balance),
...
final class $$TransactionsTableReferences
  ...
  static $AccountsTable _fromAccountIdTable(_$AppDatabase db) =>
      db.accounts.createAlias('transactions__from_account_id__accounts__id');
